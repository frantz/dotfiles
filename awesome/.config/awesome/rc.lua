...
-- Launch Bar (manual install)
local launchbar = require('launchbar')
local mylaunchbar = launchbar('/home/frantz/Desktop/')
...
beautiful.init("/home/frantz/.config/awesome/themes/grey-new/theme.lua")
...
elseif screen.count() == 2 then
	...
	tags[2] = awful.tag({ 6, 7, 8, 9 }, 2, layouts[1]) 
end
...
-- -----------------------------------------
-- Cycling through possible screens configs
-- -----------------------------------------
